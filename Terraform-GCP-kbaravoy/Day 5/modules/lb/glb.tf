# Create Global load-balancer from target
resource "google_compute_global_address" "web-lb" {
  name = "web-lb"
}

# Create backend-service from public group
...
# Create auto-scaler for public group instance
